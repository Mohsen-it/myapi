import { Body, Controller, Post, UploadedFile, UseGuards, UseInterceptors ,Request, Get, Res, Param, Put} from '@nestjs/common';
...
export class UserController {
  ...
  responseToFriendRequest(
    ...
    return this.userService.responseToFriendRequest(statusResponse.status,friendRequestId);
  }

  @UseGuards(JwtGuard)
  @Get('friend-request/me/:receiver-requests')
